            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h6>Tambah Gaji Lembur</h6>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('gaji-lembur.store', $gaji->uuid) }}" method="post" class="needs-validation"
                            novalidate="" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                    required="" name="tanggal" value="{{ old('tanggal') }}">
                                @error('tanggal')
