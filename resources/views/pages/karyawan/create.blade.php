                        ...
                        <form action="{{ route('karyawan.store') }}" method="post" class="needs-validation" novalidate=""
                            ...
                            <div class='form-group'>
                                ...
                                <select name='divisi_id' id='divisi_id'
                                    ...
                                    @foreach ($data_divisi as $divisi)
                                        <option @selected($divisi->id == old('divisi_id')) value='{{ $divisi->id }}'>
                                            {{ $divisi->nama }}</option>
                                    @endforeach
                                </select>
                                @error('divisi_id')
                            ...
                            <div class='form-group'>
                                ...
                                <select name='status_karyawan' id='status_karyawan'
                                    ...
                                    <option @selected(old('status_karyawan') == 1) value="1">Aktif</option>
                                    <option @selected(old('status_karyawan') == 2) value="2">Cuti</option>
                                    <option @selected(old('status_karyawan') == 3) value="3">Resign</option>
                                    <option @selected(old('status_karyawan') == 4) value="4">Kontrak</option>
                                    <option @selected(old('status_karyawan') == 5) value="5">Tidak Aktif</option>
                                </select>
