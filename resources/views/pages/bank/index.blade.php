        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="{{ route('bank.create') }}" class="btn btn-sm btn-primary mb-3">Tambah
                            Data</a>
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->pemilik }}</td>
                                            <td>
                                                <a href="{{ route('bank.edit', $item->id) }}" class="btn btn-sm btn-info"><i
                                                        class="fas fa-edit"></i> Edit</a>
                                                <form action="" method="post" class="d-inline" id="formDelete">
                                                    @csrf
                                                    @method('delete')
                                                    <button data-action="{{ route('bank.destroy', $item->id) }}"
