        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('spk-kriteria.update', $item->id) }}" method="post" class="needs-validation"
                            ...
                            <div class='form-group'>
                                ...
                                <select name='jenis' id='jenis'
                                    ...
                                    <option @selected($item->jenis === 'benefit') value="benefit">Benefit</option>
                                    <option @selected($item->jenis === 'cost') value="cost">Cost</option>
                                </select>
                                @error('jenis')
                                    <div class='invalid-feedback'>
                                        {{ $message }}
